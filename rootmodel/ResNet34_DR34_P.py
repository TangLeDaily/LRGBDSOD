...
class LRGBDSOD(nn.Module):
    def __init__(self, rfb_out_channel=32):
        ...
        self.A_preRGB = make_layer(CSBasicBlock, 5, inplanes=64, planes=64)
        self.A_predepth = make_layer(CSBasicBlock, 5, inplanes=64, planes=64)
        self.A_fusion = FusionAttention(64)
        self.A_fuRestoration = make_layer(CSBasicBlock, 10, inplanes=64, planes=64)
    ...
    def forward(self, low_input, high_input):
        ...
        r_A = self.A_preRGB(R_A)
        d_A = self.A_predepth(d_A)
